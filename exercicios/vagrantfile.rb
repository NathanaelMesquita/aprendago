Vagrant.configure("2") do |config|
  ...
  config.vm.define "webserver" do |webserver| 
    ...
    webserver.vm.hostname = "servidor-web" #Hostname do servidor
    webserver.vm.box_download_insecure=true  #Permitir conexão insegura
    webserver.vm.network "private_network", type: "dhcp" # Configuração de interface de rede
    ...
    webserver.vm.synced_folder "./shared_windows", "/shared_linux" # Configurações do Diretorio Compartilhado
  ...
  config.vm.define "docker" do |docker| 
    ...
    docker.vm.hostname = "servidor-docker" #Hostname do servidor
    docker.vm.box_download_insecure=true  #Permitir conexão insegura
    docker.vm.network "private_network", type: "dhcp" # Configuração de interface de rede 
